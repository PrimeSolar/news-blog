  ...
  if (footerContainer != null) {
    ...
    <div class="container pt-1 mt-1">
      <footer class="pt-1 mt-5 mb-3">
        ...
        <p class="text-center pt-3 border-top text-body-secondary">Copyright © <a href="https://primesolar.github.io/web-developer/" rel="noopener noreferrer">Vladislav Kazantsev</a> ${new Date().getFullYear()}</p>
